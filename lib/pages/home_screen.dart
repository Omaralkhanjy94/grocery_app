...
class HomeScreen extends StatelessWidget {
  ...
  Widget singleChildScrollView(BuildContext context) {
    return SingleChildScrollView(child: panel(context));
  }
    ...
    return CarouselSlider(
      ...
      options: CarouselOptions(
        ...
        onPageChanged: (index, reason) {
          ...
          // });
          context.read<OfferIndexCubit>().updateSplashCurrentIndexCubit(index);
        },
      ),
      items: offers
          .map(
      ...
      child: Row(
        children: List.generate(offers.length, (index) {
          return AnimatedContainer(
            ...
            width: context.read<OfferIndexCubit>().currentIndexNow == index
                ? 40
                : 10,
            height: 10,
            decoration: BoxDecoration(
              color: context.read<OfferIndexCubit>().currentIndexNow == index
                  ? Color(0xff6CC51D)
                  : Color(0xFFFFFFFF),
